...
# ==================== Profile Information ====================
OWNER_NAME = 'Srinivas Kongala'
OWNER_LOCATION = 'Shambhunigudem'
OWNER_PHONE = '8639407032'
OWNER_EMAIL = 'kongalasrinivas128@gmail.com'
OWNER_GITHUB = 'https://github.com/kongalasrinivas128-del'
OWNER_SUMMARY = 'To secure a challenging position in a reputable organization where I can utilize and further develop my technical skills, expand my knowledge, and contribute to the company\'s success.'

# Portfolio data - Srinivas Kongala's Projects
PORTFOLIO_ITEMS = [
    {
        'id': 1,
        'title': 'Employee Salary Prediction',
        'description': 'Employee Salary Prediction is a system that uses machine learning techniques to estimate an employee\'s salary based on various factors such as experience, education level, job role, skills, and performance.',
        'year': '2022'
    }
]
...
EDUCATION = [
    {
        ...
        'institution': 'Mother Teresa Institute of Science and Technology, Sathupalli',
        'aggregate': '8.3',
        'year': '2022-26'
    },
    {
        'degree': 'Intermediate',
        'institution': 'Gayatri Junior College Sathupalli',
        'aggregate': '63.7%',
        'year': '2020-22'
    },
    {
        'degree': '10th Class',
        'institution': 'Sri Vivakanandha Vidyalayam, Modhulagudem',
        'aggregate': '10.0',
        'year': '2020'
    }
]
...
CERTIFICATIONS = [
    'Udemy: Java Programming for Complete Beginners',
    'Cisco Netcad: Essentials of C',
    'Great learning: Python',
    'Besant Technology: Certificate of Participation in Software Testing',
    'NPTEL: Big Data Computing',
    'Infosys Spring Board: Programming Fundamentals using Python - Part 1'
]

ACHIEVEMENTS = [
    'Participated in the Hackathon On Data Science-ML-AI-2024 on BRAIN O VISION',
    'Participated in a Two Days Workshop on Advancements in Data Visualization Techniques',
    'Participated in a Three Days Workshop on Data Science-ML-AI'
]
...
def about():
    """About page"""
    user_name = session.get('user', OWNER_NAME)
...
def skills():
    """Skills page"""
    return render_template('skills.html', skills=SKILLS, certifications=CERTIFICATIONS)
...
def inject_user():
    """Inject user and owner profile data into all templates"""
    return {
